...
public class LoginModel : AccountPageModel
{
  ...
  public virtual async Task<IActionResult> OnPostAsync([FromForm] string action)
  {
    ...
    if (!result.Succeeded)
    {
      ...
      ModelState.AddModelError("LoginInput.UserNameOrEmailAddress", L["InvalidUserNameOrPassword"]);
      return Page();
    }
