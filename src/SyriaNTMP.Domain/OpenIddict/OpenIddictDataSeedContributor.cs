...
namespace SyriaNTMP.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("SyriaNTMP") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "SyriaNTMP", DisplayName = "SyriaNTMP API", Resources = { "SyriaNTMP" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        var consoleAndAngularClientId = configurationSection["SyriaNTMP_App:ClientId"];
        if (!consoleAndAngularClientId.IsNullOrWhiteSpace())
        {
            var consoleAndAngularClientRootUrl = configurationSection["SyriaNTMP_App:RootUrl"]?.TrimEnd('/');
        ...
        {
            var swaggerRootUrl = configurationSection["SyriaNTMP_Swagger:RootUrl"]?.TrimEnd('/');
        ...
        if (!nazeelClientId.IsNullOrWhiteSpace() && !nazeelClientSecret.IsNullOrWhiteSpace())
        {
            ...
            if (existingApplication == null)
            {
                ...
                application.Permissions.Add(OpenIddictConstants.Permissions.Prefixes.Scope + "SyriaNTMP");
